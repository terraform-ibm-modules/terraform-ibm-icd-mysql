...
* [Examples](./examples)
    * <div style="display: inline-block;"><a href="./examples/backup">Restore from backup example</a></div> <div style="display: inline-block; vertical-align: middle;"><a href="https://cloud.ibm.com/schematics/workspaces/create?workspace_name=im-backup-example&repository=github.com/terraform-ibm-modules/terraform-ibm-icd-mysql/tree/main/examples/backup" target="_blank"><img src="https://cloud.ibm.com/media/docs/images/icons/Deploy_to_cloud.svg" alt="Deploy to IBM Cloud button"></a></div>
    * <div style="display: inline-block;"><a href="./examples/basic">Basic with read-only replica example</a></div> <div style="display: inline-block; vertical-align: middle;"><a href="https://cloud.ibm.com/schematics/workspaces/create?workspace_name=im-basic-example&repository=github.com/terraform-ibm-modules/terraform-ibm-icd-mysql/tree/main/examples/basic" target="_blank"><img src="https://cloud.ibm.com/media/docs/images/icons/Deploy_to_cloud.svg" alt="Deploy to IBM Cloud button"></a></div>
    * <div style="display: inline-block;"><a href="./examples/complete">Complete example with BYOK encryption, CBR rules and VPE creation</a></div> <div style="display: inline-block; vertical-align: middle;"><a href="https://cloud.ibm.com/schematics/workspaces/create?workspace_name=im-complete-example&repository=github.com/terraform-ibm-modules/terraform-ibm-icd-mysql/tree/main/examples/complete" target="_blank"><img src="https://cloud.ibm.com/media/docs/images/icons/Deploy_to_cloud.svg" alt="Deploy to IBM Cloud button"></a></div>
    * <div style="display: inline-block;"><a href="./examples/fscloud">Financial Services Cloud profile example with autoscaling enabled</a></div> <div style="display: inline-block; vertical-align: middle;"><a href="https://cloud.ibm.com/schematics/workspaces/create?workspace_name=im-fscloud-example&repository=github.com/terraform-ibm-modules/terraform-ibm-icd-mysql/tree/main/examples/fscloud" target="_blank"><img src="https://cloud.ibm.com/media/docs/images/icons/Deploy_to_cloud.svg" alt="Deploy to IBM Cloud button"></a></div>
    * <div style="display: inline-block;"><a href="./examples/pitr">Point in time recovery example (PITR)</a></div> <div style="display: inline-block; vertical-align: middle;"><a href="https://cloud.ibm.com/schematics/workspaces/create?workspace_name=im-pitr-example&repository=github.com/terraform-ibm-modules/terraform-ibm-icd-mysql/tree/main/examples/pitr" target="_blank"><img src="https://cloud.ibm.com/media/docs/images/icons/Deploy_to_cloud.svg" alt="Deploy to IBM Cloud button"></a></div>
