...
<p>
  <a href="https://cloud.ibm.com/schematics/workspaces/create?workspace_name=icd-mysql-fscloud-example&repository=https://github.com/terraform-ibm-modules/terraform-ibm-icd-mysql/tree/main/examples/fscloud">
...
- An IAM authorization between all MySQL database instances in the given resource group, and the Key Protect instance that is passed in.
- An IBM Cloud Databases MySQL database instance that is encrypted with the Key Protect root key that is passed in.
...
- You need a Key Protect instance and root key available in the region that you want to deploy your MySQL database instance to.
