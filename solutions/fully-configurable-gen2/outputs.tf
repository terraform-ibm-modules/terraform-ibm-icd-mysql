...
output "next_steps_text" {
  value       = "Your Database for MySQL Gen2 instance is ready. You can now take advantage of predictable performance, dedicated compute resources, on-demand scaling, and robust security with our fully managed service"
