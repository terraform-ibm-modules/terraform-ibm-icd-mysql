# Configuring complex inputs for ICD MySQL in IBM Cloud projects

Several optional input variables in the IBM Cloud [ICD MySQL Deployable Architecture](https://cloud.ibm.com/catalog#deployable_architecture) use complex object types. You specify these inputs when you configure deployable architecture.
...
### Options for cbr_rules
  ...
  - `tags` (optional): The tag can have the following values:
